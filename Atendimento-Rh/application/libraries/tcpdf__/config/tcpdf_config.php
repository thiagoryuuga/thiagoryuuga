...
if (!defined("K_TCPDF_EXTERNAL_CONFIG")) {
	 ...
	 */
	define ("K_PATH_MAIN", "http://intranet.esmaltec.com.br/sistemas/atendimento/application/libraries/tcpdf/");

	/**
	 * url path (http://localhost/tcpdf/)
	 */
	define ("K_PATH_URL", 'http://intranet.esmaltec.com.br/sistemas/atendimento/application/libraries/tcpdf/');
