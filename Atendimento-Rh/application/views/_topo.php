                                            ...
                                            <div class="sct_left">
                                                <div class="sct_right">
                                                    ...
                                                    <ul id="menu" class="dashboard_menu">
                                                       <?php if($this->session->userdata('idLevel') == 0 || $this->session->userdata('idLevel') == 2 || $this->session->userdata('idLevel') == 1){?>
                                                       <li>
                                                       ...
                                                       <?php if($this->session->userdata('idLevel') == 0 || $this->session->userdata('idLevel') == 4 || $this->session->userdata('idLevel') == 3){?>
