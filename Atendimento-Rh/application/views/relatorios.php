...
$(function(){
	...
	$("#relat_atestado").validate();
	$("#relat_atestado2").validate();
	...
	$("#section_atestado").css('display','none');
	$("#section_atestado2").css('display','none');
	...
	$("#atendimento").click(function(){
		...
		$("#section_atestado").css('display','none');
		$("#section_atestado").hide();
		$("#section_atestado2").css('display','none');
		$("#section_atestado2").hide();
	});
	...
	$("#atestado").click(function(){
		...
		$("#section_grafico").css('display','none');
		$("#section_grafico").hide();
		$("#section_atestado").css('display','inline');
		$("#section_atestado").show();
		$("#section_atestado2").css('display','none');
		$("#section_atestado2").hide();
	});
	
	$("#atestado2").click(function(){
		$("#section_atendimento").css('display','none');
		$("#section_atendimento").hide();	
		$("#section_absenteismo").css('display','none');
		$("#section_absenteismo").hide();
		...
		$("#section_atestado").css('display','none');
		$("#section_atestado").hide();
		$("#section_atestado2").css('display','inline');
		$("#section_atestado2").show();
	});
	
	$( "#atestado-data-inicio" ).datepicker({
		maxDate: new Date(),
		changeMonth: true,
		numberOfMonths: 1,
		onClose: function( selectedDate ) {
			$( "#atestado-data-fim" ).datepicker( "option", "minDate", selectedDate );
		}
	});
	$( "#atestado-data-fim" ).datepicker({
		//defaultDate: "+1w",
		changeMonth: true,
		numberOfMonths: 1,
		maxDate: new Date(),
		onClose: function( selectedDate ) {
			$( "#atestado-data-inicio" ).datepicker( "option", "maxDate", selectedDate );
		}
	});
});
</script>
...
<div class="tudo">
             ...
             <div class="sct_right">
                <div class="sct_left">
                    ...
                    <ul id="menu" class="dashboard_menu" style="margin-left:50px;">
                        ...
                        <li id="atestado" style="cursor:pointer;"><img src="<?php echo base_url();?>images/icons-menu/atestado_medico.png"/></li>
                        <li id="atestado2" style="cursor:pointer;"><img src="<?php echo base_url();?>images/icons-menu/cid.png"/></li>
                        <li id="atendimento" style="cursor:pointer;"><img src="<?php echo base_url();?>images/icons-menu/atend_relat.png"/></li>
                        <?php } ?>
   ...
   <div id="section_absenteismo">
     ...
     <!-- Inicio do section atestado -->
     <div id="section_atestado">
     <div class="title_wrapper">
         <h2>Filtros</h2>
         <span class="title_wrapper_left"></span>
         <span class="title_wrapper_right"></span>
                ...
                <div class="sct_left">
                    ...
                    <!--[if !IE]>start dashboard menu<![endif]-->
                     <div style="float:none; margin-left:50px;" id="form" align="left">                                 
                         <div style="float:none; position:relative; height:120px;" class="form">
                            <div id="colum_left" style="float:left; width:48%;" align="right">
                                 <form action="<?php echo base_url().'index.php/relatorios/atestado';?>" method="post" id="relat_atestado">   
                                 <div style="float:left; width:30%;" align="right">
                                    <p>
     ...
     <!-- Fim do section atestado -->
     
     
     <div id="section_atestado2">
     <div class="title_wrapper">
         <h2>Filtros </h2>
         <span class="title_wrapper_left"></span>
         <span class="title_wrapper_right"></span>
     ...
     <div class="section_content">
       ...
       <div class="sct">
          <div class="sct_left">
             <div class="sct_right">
                <div class="sct_left">
                    <div id="relat" class="sct_right" align="center" style="height:250px;">
                    <!--[if !IE]>start dashboard menu<![endif]-->
                     <div style="float:none; margin-left:50px;" id="form" align="left">                                 
                         <div style="float:none; position:relative; height:120px;" class="form">
                            <div id="colum_left" style="float:left; width:48%;" align="right">
                                 <form action="<?php echo base_url().'index.php/relatorios/atestado2';?>" method="post" id="relat_atestado2">   
                                 <div style="float:left; width:30%;" align="right">
                                    <p>
                                 ...
                                 <div style="float:right; width:69.5%;" align="left">
                                    <p>
                                        <input type="text" id="atestado-data-inicio" name="data_inicio">
                                    </p>
                                    <br/>
                                    <p>
                                        <input type="text" id="atestado-data-fim" name="data_fim">
                                    </p>
                                    <br/>
                                    <p>
                                        <select name="demitido">
                                    ...
                                    <br/>
                                    <p>
                                        <select name="afastamento">
                                        	<option value="0" selected="selected">TODOS</option>
                                          <option value="20">ACIDENTE DE TRABALHO</option>
                                          <option value="21">AFASTAMENTO DE DOENÇA</option>
                                          <option value="24">LICENÇA MATERNIDADE</option>
                                        </select>
                                    </p>
                                    <br/>
                                    <p>
                                      <button type="submit" id="enviar2"  name="enviar" value="enviar"> Enviar </button>
    				           		  <button type="button" id="Limpar2"  name="Limpar" value="Limpar"> Limpar </button>
                                    </p>
                                  </div>
                                  </form>
                            </div>
