...
var gsOutOfRange="Você Não pode selecionar esse valor, fora do alcance.";	// out-of-date-range error message. If set to "", no alerts will popup on such error.
...
var gsNavPrev="<IMG id='navPrev' class='MonthNav' src='arrowl.gif' width='7' height='12' border='0' alt='' onmousedown='showPrevMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the left month navigator
var gsNavNext="<IMG id='navNext' class='MonthNav' src='arrowr.gif' width='7' height='12' border='0' alt='' onmousedown='showNextMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the right month navigator
