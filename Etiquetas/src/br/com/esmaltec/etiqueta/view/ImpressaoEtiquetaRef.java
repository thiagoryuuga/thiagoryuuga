...
public class ImpressaoEtiquetaRef extends JFrame implements ActionListener {
	...
	private JTextField qtdEtiq = new JTextField(3);
	...
	public static void main(String[] args) {
		...
		Logger log = Logger.getLogger(ImpressaoEtiquetaRef.class);
		...
		try {
			...
			ImpressaoEtiquetaRef sisEtiq = new ImpressaoEtiquetaRef(connection);
	...
	public ImpressaoEtiquetaRef(Connection connection) {

		this.connection = connection;
		logger = Logger.getLogger(ImpressaoEtiquetaRef.class);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equals("OK")
			...
			try {
				...
				ImprimeEtiqueta etiq = new ImprimeEtiqueta(codEmpresa, codItem,
						qtdEtiq.getText(), "N", "2", new Integer(2), "", connection, "",
						false, sisOper);
		...
		if (w == qtdEtiq) {
			...
			if (conteudo.length() > 0 || conteudo == null || "".equals(conteudo)) {
				try {
