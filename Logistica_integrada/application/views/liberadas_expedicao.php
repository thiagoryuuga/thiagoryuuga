...
<table cellpadding="0" cellspacing="0" width="100%" border="0" class="display" id="liberadas">
														...
														<tbody style="font-size:11px;">
															...
															<tr>
																...
																<td  style="background-color:#fff" class="center"><?php echo ($rowPendentes['HORA_ENTRADA'])?></td>
																...
																<td style="width: 200px; word-break:break-word;" class="center">
																<?php echo $rowPendentes['DOCUMENTOS']?>	
