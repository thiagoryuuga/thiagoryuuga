...
<?php } ?>
 ...
 <input name="STATUS_CARGA" id="STATUS_CARGA" type="hidden" value="<?php echo $var = empty($carga[0]['STATUS']) ? "" : $carga[0]['STATUS'] ;?>" />
	...
	<select  class="input_wrapper" style="width:50px;" id="doca" name="DOCA">
		...
		<option value="CDE_1" <?php echo $selecionado = @$carga[0]['DOCA'] == "CDE_1" ? " selected=\"selected\" " : "" ;?>>CDE_1</option>
		<option value="CDE_2" <?php echo $selecionado = @$carga[0]['DOCA'] == "CDE_2" ? " selected=\"selected\" " : "" ;?>>CDE_2</option>
		<option value="CDE_3" <?php echo $selecionado = @$carga[0]['DOCA'] == "CDE_3" ? " selected=\"selected\" " : "" ;?>>CDE_3</option>
		<option value="CDE_4" <?php echo $selecionado = @$carga[0]['DOCA'] == "CDE_4" ? " selected=\"selected\" " : "" ;?>>CDE_4</option>
		<option value="CDE_5" <?php echo $selecionado = @$carga[0]['DOCA'] == "CDE_5" ? " selected=\"selected\" " : "" ;?>>CDE_5</option>
		<option value="CDE_6" <?php echo $selecionado = @$carga[0]['DOCA'] == "CDE_6" ? " selected=\"selected\" " : "" ;?>>CDE_6</option>
		<option value="CDE_7" <?php echo $selecionado = @$carga[0]['DOCA'] == "CDE_7" ? " selected=\"selected\" " : "" ;?>>CDE_7</option>
		<option value="CDE_8" <?php echo $selecionado = @$carga[0]['DOCA'] == "CDE_8" ? " selected=\"selected\" " : "" ;?>>CDE_8</option>
		<option value="CDE_9" <?php echo $selecionado = @$carga[0]['DOCA'] == "CDE_9" ? " selected=\"selected\" " : "" ;?>>CDE_9</option>
	...
	<select  class="input_wrapper" style="width:80px;" id="conferente" name="CONFERENTE">
		...
		<option value="CLAUDIO" <?php echo $selecionado = @$carga[0]['CONFERENTE'] == "CLAUDIO" ? " selected=\"selected\" " : "" ;?>>CLAUDIO</option>
		<option value="DIONISIO" <?php echo $selecionado = @$carga[0]['CONFERENTE'] == "DIONISIO" ? " selected=\"selected\" " : "" ;?>>DIONISIO</option>
		<option value="EDSON" <?php echo $selecionado = @$carga[0]['CONFERENTE'] == "EDSON" ? " selected=\"selected\" " : "" ;?>>EDSON</option>
		...
		<option value="GLEISON" <?php echo $selecionado = @$carga[0]['CONFERENTE'] == "GLEISON" ? " selected=\"selected\" " : "" ;?>>GLEISON</option>
		<option value="ISMAEL" <?php echo $selecionado = @$carga[0]['CONFERENTE'] == "ISMAEL" ? " selected=\"selected\" " : "" ;?>>ISMAEL</option>
		<option value="MICIANO" <?php echo $selecionado = @$carga[0]['CONFERENTE'] == "MICIANO" ? " selected=\"selected\" " : "" ;?>>MICIANO</option>
		<option value="PAULO" <?php echo $selecionado = @$carga[0]['CONFERENTE'] == "PAULO" ? " selected=\"selected\" " : "" ;?>>PAULO</option>		
        <option value="WAGNER" <?php echo $selecionado = @$carga[0]['CONFERENTE'] == "WAGNER" ? " selected=\"selected\" " : "" ;?>>WAGNER</option>
...
<label style="line-height:15px;">2º Conferente</label>			
	...
	<select  class="input_wrapper" style="width:80px;" id="conferente_2" name="CONFERENTE_2">
		...
		<option value="CLAUDIO" <?php echo $selecionado = @$carga[0]['CONFERENTE_2'] == "CLAUDIO" ? " selected=\"selected\" " : "" ;?>>CLAUDIO</option>
		<option value="EDSON" <?php echo $selecionado = @$carga[0]['CONFERENTE_2'] == "EDSON" ? " selected=\"selected\" " : "" ;?>>EDSON</option>
		...
		<option value="GLEISON" <?php echo $selecionado = @$carga[0]['CONFERENTE_2'] == "GLEISON" ? " selected=\"selected\" " : "" ;?>>GLEISON</option>
		<option value="ISMAEL" <?php echo $selecionado = @$carga[0]['CONFERENTE_2'] == "ISMAEL" ? " selected=\"selected\" " : "" ;?>>ISMAEL</option>
		<option value="MICIANO" <?php echo $selecionado = @$carga[0]['CONFERENTE_2'] == "MICIANO" ? " selected=\"selected\" " : "" ;?>>MICIANO</option>
		<option value="PAULO" <?php echo $selecionado = @$carga[0]['CONFERENTE_2'] == "PAULO" ? " selected=\"selected\" " : "" ;?>>PAULO</option>
		<option value="WAGNER" <?php echo $selecionado = @$carga[0]['CONFERENTE_2'] == "WAGNER" ? " selected=\"selected\" " : "" ;?>>WAGNER</option>
	...
	<select  class="input_wrapper" style="width:80px;" id="conferente_3" name="CONFERENTE_3">
		...
		<option value="CLAUDIO" <?php echo $selecionado = @$carga[0]['CONFERENTE_3'] == "CLAUDIO" ? " selected=\"selected\" " : "" ;?>>CLAUDIO</option>
		<option value="DIONISIO" <?php echo $selecionado = @$carga[0]['CONFERENTE_3'] == "DIONISIO" ? " selected=\"selected\" " : "" ;?>>DIONISIO</option>
		<option value="EDSON" <?php echo $selecionado = @$carga[0]['CONFERENTE_3'] == "EDSON" ? " selected=\"selected\" " : "" ;?>>EDSON</option>
		...
		<option value="GLEISON" <?php echo $selecionado = @$carga[0]['CONFERENTE_3'] == "GLEISON" ? " selected=\"selected\" " : "" ;?>>GLEISON</option>
		<option value="ISMAEL" <?php echo $selecionado = @$carga[0]['CONFERENTE_3'] == "ISMAEL" ? " selected=\"selected\" " : "" ;?>>ISMAEL</option>
		<option value="MICIANO" <?php echo $selecionado = @$carga[0]['CONFERENTE_3'] == "MICIANO" ? " selected=\"selected\" " : "" ;?>>MICIANO</option>
		<option value="PAULO" <?php echo $selecionado = @$carga[0]['CONFERENTE_3'] == "PAULO" ? " selected=\"selected\" " : "" ;?>>PAULO</option>
		<option value="WAGNER" <?php echo $selecionado = @$carga[0]['CONFERENTE_3'] == "WAGNER" ? " selected=\"selected\" " : "" ;?>>WAGNER</option>
	...
	<option name="ESMALTEC" value="ESMALTEC" <?php echo @$var = $carga[0]['CAPATAZIA'] == "ESMALTEC" ? " selected=\"selected\" " : "" ;?>>ESMALTEC</option>
	<option name="ATOS" value="ATOS" <?php echo @$var = $carga[0]['CAPATAZIA'] == "ATOS" ? " selected=\"selected\" " : "" ;?>>ATOS</option>
