        ...
        <script language="javascript">
			function deletar(id) {
				if (confirm("Deseja realmente deletar?")) {
					window.location.href="<?php echo base_url()?>index.php/usuarios/deletar/"+id;
				}
			}
		</script>
          ...
          <div class="box" style=" margin:0 0 0 0; width:980px;">
              ...
              <div class="box-container">
                 <div id="quick-send-message-container">
					...
					<form id="form" action="<?php echo base_url()?>index.php/usuarios/manter" method="post">
      			...
      			<tbody>
					...
					<tr class="odd">
							...
							<td class="col-first" style="padding:10px">
								<a href="<?php echo base_url()?>index.php/usuarios/detalhar/<?php echo $row['Id']?>">[Editar]</a> - 
